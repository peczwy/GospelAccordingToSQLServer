	...
	data: () => ({
		...
		sqls:[
			...
			},
			{
				...
				sql: getContent("./GospelAccordingToSQLServer/sqls/dev/template_recreate_clustered_index_1.sql"),
			},
			{
				title: 'Log-safe delete', 
				text: 'Loop for the DELETE that counters log-growth', 
				sql: getContent("./GospelAccordingToSQLServer/sqls/dev/delete_1.sql"),
			}
		],
	}),
	methods: {
