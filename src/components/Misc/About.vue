  ...
  <v-card
    ...
    <v-card-text>
      ...
      <span class="text--primary">
        <span>
          Full-time foul-mouthed architect in Vulcan Sp. z o.o. and half-time assistant in Rzeszow University of Technology whose main area of interest satellites around data. 
