      ...
      <v-list disabled>
        <v-list-item-group color="primary">
          <v-list-item v-for="(field, i) in fields" :key="i">
            <v-list-item-icon>
              <v-icon v-text="field.icon"></v-icon>
            </v-list-item-icon>
            <v-list-item-content>
...
export default {
	...
	data: () => ({
	fields:[
		{text: 'Database Management Systems', subtext: 'NoSQL, NewSQL, RDBMS, OLTP, OLAP, Big Data, ...', icon: 'fa-database'},
		{text: 'Stream Processing', subtext: 'Kafka, Samza, Storm, Spark, ...', icon: 'fa-bolt'},
		{text: 'Data Mining / Data Science / Data Analysis', subtext: '... and other things in R', icon: 'fa-chart-bar'},
		{text: 'IT Security', subtext: 'somehow novel for me', icon: 'fa-user-secret'},
		{text: 'DevOps', subtext: 'virtualization, containers, app deployment, configuration management, ...', icon: 'fa-warehouse'},
		{text: 'Software Engineering', subtext: 'Design Patterns, Languages, ....', icon: 'fa-keyboard'},
		{text: 'Dentistry', subtext: '... I guess ...', icon: 'fa-tooth'}
	],
	articles:[
